...
build:
	@echo "==> building..."
	go build -ldflags "-X github.com/catriona-m/jirallreadyforthis/lib/version.GitCommit=${GIT_COMMIT}"
...
install:
	@echo "==> installing..."
	go install -ldflags "-X github.com/catriona-m/jirallreadyforthis/lib/version.GitCommit=${GIT_COMMIT}" .
